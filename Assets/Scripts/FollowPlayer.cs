                ...
                switch (count)
                {
                    case 4:
                        ...
                        else
                        {
                            ...
                            //if (postext1Cam1.x >= Screen.width / 2.0f)
                            //{
                            ...
                            //    textPlayer1.transform.position = new Vector3(cam.WorldToScreenPoint(GameManager.Instance.PlayerStart.PlayersReference[1].transform.position).x, Screen.height, 0);
                            //}
