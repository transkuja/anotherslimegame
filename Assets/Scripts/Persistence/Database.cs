...
namespace DatabaseClass
{
    ...
    public class Database : ScriptableObject
    {
        ...
        public RuneData GetRuneFromMinigame(GameMode minigameGameMode, int minigameVersion)
        {
            ...
            {
                if (minigameVersion%2 == 0)
                    return GetRuneFromMinigame(MinigameType.Floor, minigameVersion);
                return GetRuneFromMinigame(MinigameType.Shape, minigameVersion);
            }
        ...
        public void ResetAll() {
            ...
            string[] strMinigame = { "MinigameAntho", "MinigameAntho", "MinigameAntho", "MinigameAntho", "MinigameKart 3", "MinigamePush", "MinigamePush 1",
                    "Minigame3dRunner", "MinigameKart 2", "MinigameKart", "Minigame3dRunner 1",  "Minigame3dRunner 2", "MinigameAnthourte",
            ...
            minigames.Add(new MinigameData { Id = strMinigame[idMinigames], costToUnlock = -1, nbRunesToUnlock = -1, spriteImage = "screenshotColorType", isUnlocked = true, type = MinigameType.Floor, version = 0, difficulty = 1 });
            minigames.Add(new MinigameData { Id = strMinigame[++idMinigames], costToUnlock = -1, nbRunesToUnlock = 5, spriteImage = "screenshotColorType", isUnlocked = false, type = MinigameType.Floor, version = 2, difficulty = 3 });
            ...
            minigames.Add(new MinigameData { Id = strMinigame[++idMinigames], costToUnlock = -1, nbRunesToUnlock = 2, spriteImage = "screenshotMinigameAntho", isUnlocked = false, type = MinigameType.Floor, version = 6, difficulty = 4 });
            minigames.Add(new MinigameData { Id = strMinigame[++idMinigames], costToUnlock = -1, nbRunesToUnlock = 1, spriteImage = "screenshotEasyKart", isUnlocked = false, type = MinigameType.Kart, version = 2, difficulty = 1 });
            ...
            minigames.Add(new MinigameData { Id = strMinigame[++idMinigames], costToUnlock = -1, nbRunesToUnlock = 2, spriteImage = "screenshotRunner1", videoPreview = "VideoRunner3D",  isUnlocked = false, type = MinigameType.Runner, version = 0, difficulty = 2 });
            minigames.Add(new MinigameData { Id = strMinigame[++idMinigames], costToUnlock = -1, nbRunesToUnlock = 8, spriteImage = "screenshotSnowKart", isUnlocked = false, type = MinigameType.Kart, version = 1, difficulty = 3 });

            minigames.Add(new MinigameData { Id = strMinigame[++idMinigames], costToUnlock = -1, nbRunesToUnlock = 26, spriteImage = "screenshotMinigameKart", isUnlocked = false, type = MinigameType.Kart, version = 0, difficulty = 5 });

            minigames.Add(new MinigameData { Id = strMinigame[++idMinigames], costToUnlock = -1, nbRunesToUnlock = 10, spriteImage = "screenshotRunner2", isUnlocked = false, type = MinigameType.Runner, version = 1, difficulty = 5 });
            minigames.Add(new MinigameData { Id = strMinigame[++idMinigames], costToUnlock = -1, nbRunesToUnlock = 26, spriteImage = "screenshotRunner3", isUnlocked = false, type = MinigameType.Runner, version = 2, difficulty = 5 });
            minigames.Add(new MinigameData { Id = strMinigame[++idMinigames], costToUnlock = -1, nbRunesToUnlock = -1, spriteImage = "screenshotColorShape2", isUnlocked = true, type = MinigameType.Shape, version = 1, difficulty = 1 });
            minigames.Add(new MinigameData { Id = strMinigame[++idMinigames], costToUnlock = -1, nbRunesToUnlock = 21, spriteImage = "screenshotColorShape2", isUnlocked = false, type = MinigameType.Shape, version = 3, difficulty = 3 });
            minigames.Add(new MinigameData { Id = strMinigame[++idMinigames], costToUnlock = -1, nbRunesToUnlock = -1, spriteImage = "screenshotMinigameAntho2", isUnlocked = true, type = MinigameType.Shape, version = 5, difficulty = 2 });
            minigames.Add(new MinigameData { Id = strMinigame[++idMinigames], costToUnlock = -1, nbRunesToUnlock = 10, spriteImage = "screenshotMinigameAntho2", isUnlocked = false, type = MinigameType.Shape, version = 7, difficulty = 5 });

            // TODO: needs a screenshot
            minigames.Add(new MinigameData { Id = strMinigame[++idMinigames], costToUnlock = -1, nbRunesToUnlock = 5, spriteImage = "screenshotFood1", isUnlocked = false, type = MinigameType.Food, difficulty = 1 });
            minigames.Add(new MinigameData { Id = strMinigame[++idMinigames], costToUnlock = -1, nbRunesToUnlock = 14, spriteImage = "screenshotFood2", isUnlocked = false, type = MinigameType.Food, version = 1, difficulty = 2 });
            minigames.Add(new MinigameData { Id = strMinigame[++idMinigames], costToUnlock = -1, nbRunesToUnlock = 21, spriteImage = "screenshotFood3", isUnlocked = false, type = MinigameType.Food, version = 2, difficulty = 2 });
            minigames.Add(new MinigameData { Id = strMinigame[++idMinigames], costToUnlock = -1, nbRunesToUnlock = 31, spriteImage = "screenshotFood4", isUnlocked = false, type = MinigameType.Food, version = 3, difficulty = 3 });

            minigames.Add(new MinigameData { Id = strMinigame[++idMinigames], costToUnlock = -1, nbRunesToUnlock = 18, spriteImage = "screenshotJar", isUnlocked = false, type = MinigameType.Clash, version = 2, difficulty = 1 });
            minigames.Add(new MinigameData { Id = strMinigame[++idMinigames], costToUnlock = -1, nbRunesToUnlock = 31, spriteImage = "screenshotBewareRabbits", isUnlocked = false, type = MinigameType.Clash, version = 3, difficulty = 3 });
            minigames.Add(new MinigameData { Id = strMinigame[++idMinigames], costToUnlock = -1, nbRunesToUnlock = 14, spriteImage = "screenshotGravity", isUnlocked = false, type = MinigameType.Clash, version = 4, difficulty = 4 });
            ...
            runes.Add(new RuneData { Id = strRune[++idRune], isUnlocked = false, unlockedInMinigame = true, associatedMinigame = MinigameType.Shape, associatedMinigameVersion = 7 });
            ...
            runes.Add(new RuneData { Id = strRune[++idRune], isUnlocked = false, unlockedInMinigame = true, associatedMinigame = MinigameType.Shape, associatedMinigameVersion = 3 });
            ...
            hats.Add(new HatData { Id = strHat[++idHat], model = "Hats/GlitterHat", spriteUnlock = "glitterhat", shouldHideEars = true, isUnlocked = false, costToUnlock = -1 });
